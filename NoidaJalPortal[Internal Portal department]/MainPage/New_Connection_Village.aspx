<%@ Page Language="C#" MasterPageFile="~/noidajal.master" AutoEventWireup="true"
    CodeFile="New_Connection_Village.aspx.cs" Inherits="New_Connection" Title="NoidaJal::New Connection" %>
    ...
    <div id="div_main" runat="server">
                                ...
                                <ContentTemplate>
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="pageControl">
                                                <asp:TextBox ID="txt_House_No" CssClass="td_text" runat="server" MaxLength="6">0</asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pageLabel"><asp:TextBox ID="txtRid" runat="server" MaxLength="15" Width="160px"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvRid" runat="server" ErrorMessage="*"
                                            ControlToValidate="txtRid" SetFocusOnError="True"></asp:RequiredFieldValidator></td>
                                        </tr>
                                    </table>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                            ...
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td class="pageControl">
                                          ...
                                          <asp:RequiredFieldValidator ID="RequiredFieldValidatortxt_Mobile_No" runat="server" ErrorMessage="*"
         ControlToValidate="txt_Mobile_No"></asp:RequiredFieldValidator></br>
        <asp:RegularExpressionValidator ID="RegularExpressionValidatorttxt_Mobile_No" runat="server"
        ...
        ValidationExpression="^([6-9]{1})([0-9]{9})$"></asp:RegularExpressionValidator>
                                ...
                                <tr>
                                    ...
                                    <td class="pageControl">
                                        <asp:TextBox ID="txt_khasra_no" CssClass="td_text" runat="server"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*"
                                            ControlToValidate="txt_khasra_no"></asp:RequiredFieldValidator>
                                    </td>
                                    <td class="pageLabel">
                                        Village Name
                                    </td>
                                    <td class="pageControl">
                                        <asp:DropDownList ID="ddl_village_name" CssClass="td_text" runat="server">
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*"
                                            ControlToValidate="ddl_village_name" InitialValue="0"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
