<%@ Page Language="C#" MasterPageFile="~/noidajal.master" AutoEventWireup="true" CodeFile="user_attendance.aspx.cs" Inherits="MainPage_user_attendance" Title="Untitled Page" %>
...
<div style="height:390px; width:400px; background-color:white" >
    </br></br> <asp:Label ID="timeviewlbl" runat="server" Text="TIME IN/OUT" 
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <tr><td>
            ...
            <tr><td>
            <asp:Button ID="Button1" runat="server" Text="Time In" BackColor="Green" 
         ...
         <tr><td> <asp:Label ID="timeoutlabel" runat="server" Text="TIME OUT" Width="150px"></asp:Label></td></tr>
                <tr><td>
                <asp:Button ID="timeoutbtn" runat="server" Text="Time Out" BackColor="Red" 
