<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PageButton.ascx.cs" Inherits="PageButton" %>
<center>
                ...
                <fieldset>
                    ...
                    <asp:GridView ID="gridSearch" runat="server" AutoGenerateColumns="False" HeaderStyle-CssClass="gridHeader"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Connection No.">
                                <ItemTemplate>
                                    <asp:LinkButton ID="linkCons" runat="server" Text='<%# Eval("CONS_NO") %>' OnClick="linkCons_Click"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
