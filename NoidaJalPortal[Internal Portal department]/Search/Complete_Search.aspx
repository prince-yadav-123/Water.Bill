<%@ Page Language="C#" MasterPageFile="~/noidajal.master" AutoEventWireup="true" CodeFile="Complete_Search.aspx.cs" Inherits="Search_complete_search" Title="NoidaJal:Search" %>
...
<center>
        <table cellpadding="1" cellspacing="0" width="800px" style="vertical-align: top;">
                        ...
                        <table>
                            <tr id="tr2" runat="server" visible="true">
                                ...
                                <td class="pageControl">
                                    <asp:TextBox ID="txt_cons_no" runat="server" MaxLength="8" CssClass="td_text_search"></asp:TextBox>
                                </td>
            ...
            <tr>
                <td valign="top">
                    <div style="text-align: center;  width: 800px;height:250px; overflow: scroll;" id="div1"
                        runat="server">
                        <fieldset>
                            <legend>Challan View</legend>
            ...
            <tr>
                <td valign="top">
                    <div style="text-align: center;  width: 800px; overflow: scroll;" id="div2"
                        runat="server">
                        <fieldset>
                            <legend>Challan View</legend>
