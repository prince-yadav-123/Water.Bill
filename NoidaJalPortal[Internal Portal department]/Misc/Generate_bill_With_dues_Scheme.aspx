<%@ Page Language="C#" MasterPageFile="~/noidajal.master" AutoEventWireup="true"
    CodeFile="Generate_bill_With_dues_Scheme.aspx.cs" Inherits="Update_Generate_bill"
    Title="NoidaJal::Generate Bill" %>
...
//                    alert(d);                   
                   var result = JSON.parse(d);
                     ...
                     $.each(result, function (index, obj) {
                                      ...
                                      var DiscountAmt = Math.round((parseInt(obj.AREAR_INT) * parseInt(obj.BILL_PERCENTAGE))/100);
                                      //alert(DiscountAmt);
                                      
                                      if (obj.CON_TP == "Housing") {
                                      TotalAmount = parseInt(obj.MIN_TOTAL_AMT)- parseInt(obj.LAST_PAID_AMT)- parseInt(obj.BILL_REBATE_AMT) + parseInt(obj.CESS_AMT) + parseInt(obj.AREAR) + parseInt(obj.AREAR_INT) - DiscountAmt - parseInt(obj.adv_amt);                                                                           
                                      }
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RadioButtonList ID="rblPaymentType" runat="server" AutoPostBack="True">
                                                <asp:ListItem Value="1" Selected="True">RTGS/NEFT/IMPS</asp:ListItem>
                                                <asp:ListItem Value="2">DD/Cash/Fund Transfer/Cheque</asp:ListItem>
