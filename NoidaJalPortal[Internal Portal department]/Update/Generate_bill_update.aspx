<%@ Page Language="C#" MasterPageFile="~/noidajal.master" AutoEventWireup="true"
    CodeFile="Generate_bill_update.aspx.cs" Inherits="Update_Generate_bill" Title="NoidaJal::Update Bill" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    function GetAmount()
    {
        ...
        var a = document.getElementById('<%=txt_min_charges.ClientID %>').value;
        var b=	document.getElementById('<%=txt_rebate_per.ClientID %>').value;
       // alert(a);
        var c = a*12;
        var z= (c*b)/100;
        document.getElementById( '<%=txt_t_min_charge.ClientID %>').value = c;
        document.getElementById( '<%=txt_rebate_t_amt.ClientID %>').value =z;
        //alert(c)

    }
    function f2()
    {
       document.getElementById( '<%=txt_arear_amt.ClientID %>').value = 0;
        document.getElementById( '<%=txt_intrest_amt.ClientID %>').value =0; 
    }
    </script>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pageControl">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"
                                                ControlToValidate="txt_due_date" InitialValue="0"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="pageLabel">
                            ...
                            <ContentTemplate>
                                <table style="width:85%;">
                                    <tr>
                                        ...
                                        <td class="pageControl">
                                            <asp:TextBox ID="txt_min_charges" runat="server" CssClass="td_text" onkeyup="GetAmount()"
                                    ...
                                    <tr>
                                        ...
                                        <td class="pageControl">
                                            <asp:TextBox ID="txt_rebate_per" runat="server" CssClass="td_text" MaxLength="5" onkeyup="GetAmount()"> </asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pageControl">
                                           <input id="btnArrearR" type="button" value="Reset" onclick="f2();" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="pageLabel">
            ...
            <tr>
                <td colspan="4" align="center">
                    ...
                    <asp:Button ID="btnPrint" runat="server" Text="Print" CausesValidation="false" ToolTip="Click Print"
                        AccessKey="p" OnClick="btnPrint_Click" />
                </td>
            </tr>
        </table>
    </center>
