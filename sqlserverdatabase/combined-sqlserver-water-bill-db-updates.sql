...
IF OBJECT_ID(N'dbo.securitysettings', N'U') IS NOT NULL
   AND COL_LENGTH(N'dbo.securitysettings', N'ConsumerLoginOtpEnabled') IS NULL
BEGIN
    ALTER TABLE dbo.securitysettings
        ADD ConsumerLoginOtpEnabled BIT NOT NULL
            CONSTRAINT DF_securitysettings_ConsumerLoginOtpEnabled DEFAULT (1);
END;
...
(
    ...
    FROM (VALUES
        ...
        (N'WorkflowForward', N'Workflow Forwarded', N'Workflow application forwarded to next approver.', N'["ApplicationNo","StageName","Remarks","Date"]', 1, 1),
        (N'WorkflowSentBack', N'Workflow Sent Back', N'Workflow application sent back to applicant for correction.', N'["ApplicationNo","StageName","Remarks","Date"]', 1, 1),
        (N'WorkflowSentBackPrevious', N'Workflow Sent Back Previous Stage', N'Workflow application returned to previous stage for re-review.', N'["ApplicationNo","StageName","Remarks","Date"]', 1, 1),
        (N'WorkflowAssigned', N'Workflow Assigned', N'Workflow application assigned to approver.', N'["ApplicationNo","StageName","Date"]', 1, 1),
        (N'WorkflowResubmitted', N'Workflow Resubmitted', N'Workflow application resubmitted by applicant.', N'["ApplicationNo","StageName","Remarks","Date"]', 1, 1),
...
(
    ...
    JOIN (VALUES
        ...
        (N'WorkflowForward', N'InApp', N'Workflow Forwarded In-App', N'Application Forwarded to You', N'Application {{ApplicationNo}} has been forwarded to you for review. Remarks: {{Remarks}}'),
        (N'WorkflowSentBack', N'InApp', N'Workflow Sent Back In-App', N'Application Requires Correction', N'Your application {{ApplicationNo}} has been returned for correction. Remarks: {{Remarks}}'),
        (N'WorkflowSentBackPrevious', N'InApp', N'Workflow Sent Back Previous In-App', N'Application Sent Back for Re-Review', N'Application {{ApplicationNo}} has been sent back to stage {{StageName}} for re-review. Remarks: {{Remarks}}'),
        (N'WorkflowAssigned', N'InApp', N'Workflow Assigned In-App', N'Approval task assigned', N'Application {{ApplicationNo}} is assigned for action.'),
        (N'WorkflowResubmitted', N'InApp', N'Workflow Resubmitted In-App', N'Application Resubmitted', N'Application {{ApplicationNo}} has been corrected and resubmitted by the applicant. Please review.'),
