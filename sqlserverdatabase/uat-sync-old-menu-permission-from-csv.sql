...
INSERT INTO #PermissionModuleSeed (Id, Name, IsActive, IsDeleted, PortalScope) VALUES
    ...
    (22, N'Connection Subcategory Master', 1, 0, N'Authority'),
...
INSERT INTO #MenuSeed (Id, TenantId, ParentId, Label, Icon, Url, SectionLabel, ModuleName, ModuleId, MenuOrder, ShowInSidebar, IsActive, IsDeleted, CreatedAt, UpdatedAt, OpenInNewTab) VALUES
    ...
    (114, 1, 109, N'Connection Subcategory Master', N'ST', N'/Masters/connection-sub-types', N'Connection Masters', NULL, 22, 7, 1, 1, 0, CAST('2026-05-21 15:39:55.285202' AS DATETIME2(6)), CAST('2026-06-12 10:39:24.702758' AS DATETIME2(6)), 0),
