/*
    Water.Bill UAT compatible SQL Server 2014 update script
    ...
    Compatibility notes
    -------------------
    - Prepared specifically for UAT SQL Server 2014 execution.
    - Avoids ISJSON() usage.
    - Adds collation-safe comparisons for mixed-collation databases.
    - Uses INT-based securitysettings seed compatible with the normalized table shape.
...
BEGIN
    ...
    SET PortalScope = CASE
        WHEN Name COLLATE DATABASE_DEFAULT IN (
...
INSERT INTO @AppRolesSeed (Id, Name, Description, Permissions, IsDeleted)
VALUES
...
FROM dbo.AppRoles tgt
JOIN @AppRolesSeed src ON tgt.Id = src.Id;
...
SET tgt.Description = src.Description,
    ...
    tgt.UpdatedAt = SYSDATETIME()
FROM dbo.AppRoles tgt
JOIN @AppRolesSeed src
  ON tgt.Name COLLATE DATABASE_DEFAULT = src.Name COLLATE DATABASE_DEFAULT
WHERE NOT EXISTS (SELECT 1 FROM dbo.AppRoles x WHERE x.Id = src.Id);

SET IDENTITY_INSERT dbo.AppRoles ON;

INSERT INTO dbo.AppRoles (Id, Name, Description, Permissions, CreatedAt, UpdatedAt, IsDeleted)
SELECT src.Id, src.Name, src.Description, src.Permissions, SYSDATETIME(), NULL, src.IsDeleted
FROM @AppRolesSeed src
WHERE NOT EXISTS (SELECT 1 FROM dbo.AppRoles tgt WHERE tgt.Id = src.Id)
  AND NOT EXISTS
  (
      SELECT 1
      FROM dbo.AppRoles tgt
      WHERE tgt.Name COLLATE DATABASE_DEFAULT = src.Name COLLATE DATABASE_DEFAULT
  );
...
FROM dbo.AppRoles
WHERE Name COLLATE DATABASE_DEFAULT = N'Admin';

IF @AdminRoleId IS NOT NULL
BEGIN
    UPDATE dbo.AppUsers
    SET FullName = N'System Administrator',
        Email = N'admin@waterbill.local',
        Username = N'admin',
        PasswordHash = N'7KoxPJvp8WR5itphuA1oNlQ1X530kLs/uxbAtSXpz10=',
        IsActive = 1,
        RoleId = @AdminRoleId,
        PhoneNumber = NULL,
        IsDeleted = 0,
        UpdatedAt = SYSDATETIME()
    WHERE Username COLLATE DATABASE_DEFAULT = N'admin';
    ...
    BEGIN
        ...
        (
            FullName, Email, Username, PasswordHash, IsActive, RoleId, PhoneNumber,
            PasswordChangedAt, LastLoginAt, LastLoginIp, CreatedAt, UpdatedAt, IsDeleted
        )
        VALUES
        (
            N'System Administrator',
            N'admin@waterbill.local',
            N'admin',
            N'7KoxPJvp8WR5itphuA1oNlQ1X530kLs/uxbAtSXpz10=',
            1,
            @AdminRoleId,
            NULL,
            NULL,
...
BEGIN
    ...
    (
        ...
        WHERE Name COLLATE DATABASE_DEFAULT = N'Operator Activity Logs'
          AND IsDeleted = 0
    )
    AND NOT EXISTS
    (
        SELECT 1
        FROM dbo.PermissionModules
        WHERE Name COLLATE DATABASE_DEFAULT = N'User Activity Logs'
          AND IsDeleted = 0
    )
    BEGIN
        UPDATE dbo.PermissionModules
...
BEGIN
    ...
    SET Label = N'User Activity Logs',
        ...
        IsDeleted = 0,
        UpdatedAt = SYSDATETIME()
    WHERE Label COLLATE DATABASE_DEFAULT = N'Operator Activity Logs'
      AND IsDeleted = 0;
END;
...
(
    ...
    FROM (VALUES
        ...
        (N'Connection Subcategory Master', N'Authority'),
...
(
    ...
    WHERE r.Name COLLATE DATABASE_DEFAULT = N'Admin'
      AND r.IsDeleted = 0
      AND pm.IsDeleted = 0
) AS src
...
(
    ...
    JOIN dbo.PermissionModules pm
      ON pm.Name COLLATE DATABASE_DEFAULT IN
      (
    ...
    WHERE r.Name COLLATE DATABASE_DEFAULT = N'Consumer'
      AND r.IsDeleted = 0
      AND pm.IsDeleted = 0
) AS src
ON tgt.RoleId = src.RoleId AND tgt.ModuleId = src.ModuleId
...
(
    ...
    FROM (VALUES
        ...
        (1, N'Masters', N'Connection Subcategory Master', N'CS', N'/Masters/connection-sub-types', N'Masters', N'Connection Subcategory Master', 7, 1, 1, 0),
...
(
    ...
    LEFT JOIN dbo.PermissionModules pm
        ON pm.Name COLLATE DATABASE_DEFAULT = s.ModuleName COLLATE DATABASE_DEFAULT
       AND pm.IsDeleted = 0
) AS src
...
(
    ...
    FROM (VALUES
        ...
        (N'NewConnectionForwarded', N'New Connection Forwarded', N'New connection application forwarded to next stage.', N'["ApplicantName","ConsumerName","ApplicationNo","ApplicationNumber","StageName","Remarks","ActionBy","ActionDate","Date","PortalUrl","ConsumerNumber","ConsumerNo"]', 1, 1),
        (N'NewConnectionSentBack', N'New Connection Sent Back', N'New connection application sent back for correction.', N'["ApplicantName","ConsumerName","ApplicationNo","ApplicationNumber","StageName","Remarks","ActionBy","ActionDate","Date","PortalUrl","ConsumerNumber","ConsumerNo"]', 1, 1),
        (N'NewConnectionResubmitted', N'New Connection Resubmitted', N'New connection application resubmitted by applicant.', N'["ApplicantName","ConsumerName","ApplicationNo","ApplicationNumber","StageName","Remarks","ActionBy","ActionDate","Date","PortalUrl","ConsumerNumber","ConsumerNo"]', 1, 1),
        (N'NewConnectionRejected', N'New Connection Rejected', N'New connection application rejected.', N'["ApplicantName","ConsumerName","ApplicationNo","ApplicationNumber","StageName","Remarks","ActionBy","ActionDate","Date","PortalUrl","ConsumerNumber","ConsumerNo"]', 1, 1),
...
ON tgt.PurposeKey COLLATE DATABASE_DEFAULT = src.PurposeKey COLLATE DATABASE_DEFAULT
WHEN MATCHED THEN
    UPDATE SET
...
(
    ...
    JOIN (VALUES
        ...
        (N'NewConnectionSubmitted', N'SMS', N'New Connection Submitted SMS', NULL, N'Your new connection application {{ApplicationNo}} has been submitted successfully.'),
        (N'NewConnectionSubmitted', N'WhatsApp', N'New Connection Submitted WhatsApp', NULL, N'Your new connection application {{ApplicationNo}} has been submitted successfully.'),
        ...
        (N'NewConnectionForwarded', N'Email', N'New Connection Forwarded Email', N'Application {{ApplicationNo}} forwarded', N'Dear {{ApplicantName}},<br>Your application {{ApplicationNo}} has been forwarded to {{StageName}} on {{Date}}.<br>Remarks: {{Remarks}}.<br><br>Portal: {{PortalUrl}}'),
        (N'NewConnectionForwarded', N'SMS', N'New Connection Forwarded SMS', NULL, N'Your application {{ApplicationNo}} has been forwarded to {{StageName}}.'),
        (N'NewConnectionForwarded', N'WhatsApp', N'New Connection Forwarded WhatsApp', NULL, N'Your application {{ApplicationNo}} has been forwarded to {{StageName}}.'),
        (N'NewConnectionForwarded', N'InApp', N'New Connection Forwarded In-App', N'Application forwarded', N'Your application {{ApplicationNo}} has been forwarded to {{StageName}}.'),
        (N'NewConnectionSentBack', N'Email', N'New Connection Sent Back Email', N'Application {{ApplicationNo}} sent back', N'Dear {{ApplicantName}},<br>Your application {{ApplicationNo}} has been sent back for correction on {{Date}}.<br>Remarks: {{Remarks}}.<br><br>Portal: {{PortalUrl}}'),
        (N'NewConnectionSentBack', N'SMS', N'New Connection Sent Back SMS', NULL, N'Your application {{ApplicationNo}} has been sent back for correction.'),
        (N'NewConnectionSentBack', N'WhatsApp', N'New Connection Sent Back WhatsApp', NULL, N'Your application {{ApplicationNo}} has been sent back for correction.'),
        (N'NewConnectionSentBack', N'InApp', N'New Connection Sent Back In-App', N'Application sent back', N'Your application {{ApplicationNo}} has been sent back for correction.'),
        (N'NewConnectionResubmitted', N'Email', N'New Connection Resubmitted Email', N'Application {{ApplicationNo}} resubmitted', N'Dear {{ApplicantName}},<br>Your application {{ApplicationNo}} has been resubmitted on {{Date}}.<br><br>Portal: {{PortalUrl}}'),
        (N'NewConnectionResubmitted', N'SMS', N'New Connection Resubmitted SMS', NULL, N'Your application {{ApplicationNo}} has been resubmitted successfully.'),
        (N'NewConnectionResubmitted', N'WhatsApp', N'New Connection Resubmitted WhatsApp', NULL, N'Your application {{ApplicationNo}} has been resubmitted successfully.'),
        (N'NewConnectionResubmitted', N'InApp', N'New Connection Resubmitted In-App', N'Application resubmitted', N'Your application {{ApplicationNo}} has been resubmitted successfully.'),
        (N'NewConnectionRejected', N'Email', N'New Connection Rejected Email', N'Application {{ApplicationNo}} rejected', N'Dear {{ApplicantName}},<br>Your application {{ApplicationNo}} has been rejected on {{Date}}.<br>Remarks: {{Remarks}}.<br><br>Portal: {{PortalUrl}}'),
        (N'NewConnectionRejected', N'SMS', N'New Connection Rejected SMS', NULL, N'Your application {{ApplicationNo}} has been rejected.'),
        (N'NewConnectionRejected', N'WhatsApp', N'New Connection Rejected WhatsApp', NULL, N'Your application {{ApplicationNo}} has been rejected.'),
        (N'NewConnectionRejected', N'InApp', N'New Connection Rejected In-App', N'Application rejected', N'Your application {{ApplicationNo}} has been rejected.'),
        ...
        (N'NewConnectionApproved', N'Email', N'New Connection Approved Email', N'Application {{ApplicationNo}} approved', N'Dear {{ApplicantName}},<br>Your application {{ApplicationNo}} has been approved on {{Date}}.<br><br>Portal: {{PortalUrl}}'),
        (N'NewConnectionApproved', N'SMS', N'New Connection Approved SMS', NULL, N'Your application {{ApplicationNo}} has been approved.'),
        (N'NewConnectionApproved', N'WhatsApp', N'New Connection Approved WhatsApp', NULL, N'Your application {{ApplicationNo}} has been approved.'),
        ...
        (N'FinalConsumerCreated', N'Email', N'Final Consumer Created Email', N'Consumer number generated', N'Dear {{ApplicantName}},<br>Your consumer number {{ConsumerNo}} has been generated successfully for application {{ApplicationNo}} on {{Date}}.<br><br>Portal: {{PortalUrl}}'),
        (N'FinalConsumerCreated', N'SMS', N'Final Consumer Created SMS', NULL, N'Your consumer number {{ConsumerNo}} has been generated successfully.'),
        (N'FinalConsumerCreated', N'WhatsApp', N'Final Consumer Created WhatsApp', NULL, N'Your consumer number {{ConsumerNo}} has been generated successfully.'),
    ...
    ) v (PurposeKey, Channel, TemplateName, Subject, Body) ON v.PurposeKey COLLATE DATABASE_DEFAULT = p.PurposeKey COLLATE DATABASE_DEFAULT
) AS src
ON tgt.PurposeKey COLLATE DATABASE_DEFAULT = src.PurposeKey COLLATE DATABASE_DEFAULT
   AND tgt.Channel COLLATE DATABASE_DEFAULT = src.Channel COLLATE DATABASE_DEFAULT
   AND ISNULL(tgt.Language, N'') COLLATE DATABASE_DEFAULT = ISNULL(src.Language, N'') COLLATE DATABASE_DEFAULT
   AND tgt.IsDeleted = 0
WHEN MATCHED THEN
    UPDATE SET
...
ON tgt.CategoryName COLLATE DATABASE_DEFAULT = src.CategoryName COLLATE DATABASE_DEFAULT
WHEN MATCHED THEN
    UPDATE SET
        tgt.Description = src.Description,
...
(
    ...
    FROM stage_seed s
    JOIN dbo.WorkflowMasters wm ON wm.ApplicationType COLLATE DATABASE_DEFAULT = s.ApplicationType COLLATE DATABASE_DEFAULT
) AS src
ON tgt.WorkflowId = src.WorkflowId
   AND tgt.StageOrder = src.StageOrder
   AND tgt.StageName COLLATE DATABASE_DEFAULT = src.StageName COLLATE DATABASE_DEFAULT
WHEN MATCHED THEN
    UPDATE SET
...
BEGIN
    UPDATE dbo.securitysettings
    SET SessionTimeoutMinutes = 480,
        IdleTimeoutMinutes = 30,
        PasswordMinLength = 8,
        PasswordRequireUppercase = 1,
        PasswordRequireLowercase = 1,
        PasswordRequireDigit = 1,
        PasswordRequireSpecialChar = 1,
        PasswordExpiryDays = 90,
        PasswordHistoryCount = 5,
        MaxFailedLoginAttempts = 5,
        LockoutDurationMinutes = 15,
        EnableCaptchaAfterFailures = 0,
        CaptchaAfterAttempts = 3,
        AllowMultipleSessions = 1,
        BlockNewLoginOnConflict = 0,
        IsDeleted = 0,
        UpdatedAt = SYSDATETIME()
    WHERE TenantId = 1;

    IF NOT EXISTS (SELECT 1 FROM dbo.securitysettings WHERE TenantId = 1)
    BEGIN
        INSERT INTO dbo.securitysettings
               (TenantId, SessionTimeoutMinutes, IdleTimeoutMinutes, PasswordMinLength,
        ...
        VALUES (1, 480, 30, 8, 1, 1, 1, 1, 90, 5, 5, 15, 0, 3, 1, 0, SYSDATETIME(), NULL, 0);
    END;
END;
...
/* ============================================================
   16) DOCUMENT TYPE MASTER - ISMANDATORY
   ============================================================ */
