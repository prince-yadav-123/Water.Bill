...
BEGIN
    ...
    (
        Id            UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_LoginAttempts PRIMARY KEY,
...
BEGIN
    ...
    (
        Id                           UNIQUEIDENTIFIER NOT NULL CONSTRAINT PK_securitysettings PRIMARY KEY,
...
/* ============================================================
   5) NOTICE / METER READING MODULES
   ============================================================ */
...
(
    ...
    FROM (VALUES
        ...
        (1, N'Consumers', N'fa fa-users', N'#', N'Operations', N'Consumers', 2, 1, 1, 0),
        (1, N'Billing', N'fa fa-file-invoice', N'#', N'Operations', N'Billing', 3, 1, 1, 0),
        (1, N'Payments', N'fa fa-credit-card', N'#', N'Operations', N'Payments', 4, 1, 1, 0),
        (1, N'Reports', N'fa fa-chart-line', N'#', N'Reports', N'Reports', 5, 1, 1, 0),
...
(
    ...
    FROM (VALUES
        ...
        (1, N'Administration', N'Consumer Query Management', N'QY', N'/ConsumerQueryManagement', N'Administration', N'Consumer Query Management', 9, 1, 1, 0),
        ...
        (1, N'Administration', N'NotificationManagement', N'NT', N'/NotificationManagement', N'Administration', N'NotificationManagement', 11, 1, 1, 0),
        (1, N'Administration', N'Operator Activity Logs', N'AL', N'/OperatorAudit', N'Administration', N'Operator Activity Logs', 12, 1, 1, 0),
        (1, N'Billing', N'Bill Search & Print', N'BS', N'/BillSearchPrint', N'Billing', N'Bill Search & Print', 1, 1, 1, 0),
        (1, N'Billing', N'Challan Management', N'CH', N'/ChallanManagement', N'Billing', N'Challan Management', 2, 1, 1, 0),
        (1, N'Billing', N'Bulk Bill Generation', N'BB', N'/BulkBillGeneration', N'Billing', N'Bulk Bill Generation', 3, 1, 1, 0),
        (1, N'Billing', N'Advanced Bill Revision / Reversal', N'BR', N'/BillRevision', N'Billing', N'Advanced Bill Revision / Reversal', 4, 1, 1, 0),
        (1, N'Billing', N'Consumer Ledger', N'LG', N'/ConsumerLedger', N'Billing', N'Consumer Ledger', 5, 1, 1, 0),
        (1, N'Billing', N'Consumer Account Adjustments', N'AD', N'/ConsumerAccountAdjustments', N'Billing', N'Consumer Account Adjustments', 6, 1, 1, 0),
        (1, N'Billing', N'Consumer Master Maintenance', N'CM', N'/ConsumerMasterMaintenance', N'Billing', N'Consumer Master Maintenance', 7, 1, 1, 0),
        (1, N'Billing', N'Meter Reading Management', N'MR', N'/MeterReadingManagement', N'Billing', N'Meter Reading Management', 8, 1, 1, 0),
        (1, N'Billing', N'Disconnection / Reconnection Management', N'DR', N'/DisconnectionReconnectionManagement', N'Billing', N'Disconnection / Reconnection Management', 9, 1, 1, 0),
        (1, N'Billing', N'Connection Type / Category Change', N'CC', N'/ConnectionTypeCategoryChange', N'Billing', N'Connection Type / Category Change', 10, 1, 1, 0),
        (1, N'Billing', N'Name Transfer / Mutation', N'NM', N'/NameTransferMutation', N'Billing', N'Name Transfer / Mutation', 11, 1, 1, 0),
        (1, N'Billing', N'NDC Applications', N'ND', N'/NDCApplications', N'Billing', N'NDC Applications', 12, 1, 1, 0),
        (1, N'Billing', N'NDC Certificate Management', N'NC', N'/NdcCertificateManagement', N'Billing', N'NDC Certificate Management', 13, 1, 1, 0),
        (1, N'Billing', N'Consumer NDC Applications', N'CN', N'/ConsumerNdcApplications', N'Billing', N'Consumer NDC Applications', 14, 1, 1, 0),
        (1, N'Billing', N'Consumer Challans', N'CC', N'/ConsumerChallans', N'Billing', N'Consumer Challans', 15, 1, 1, 0),
        (1, N'Payments', N'Online Payment History', N'PH', N'/OnlinePaymentHistory', N'Payments', N'Online Payment History', 1, 1, 1, 0),
        (1, N'Reports', N'Reports / MIS', N'RP', N'/ReportsMis', N'Reports', N'Reports / MIS', 1, 1, 1, 0),
        ...
        (1, N'Consumers', N'Consumer Dashboard', N'CD', N'/Consumer/Dashboard', N'Consumers', N'Consumer Dashboard', 1, 1, 1, 0),
        (1, N'Consumers', N'Consumer Bills', N'CB', N'/Consumer/Bills', N'Consumers', N'Consumer Bills', 2, 1, 1, 0),
        (1, N'Consumers', N'Consumer Profile', N'CP', N'/Consumer/Profile', N'Consumers', N'Consumer Profile', 3, 1, 1, 0),
        (1, N'Consumers', N'Consumer New Connection', N'CN', N'/Consumer/NewConnection', N'Consumers', N'Consumer New Connection', 4, 1, 1, 0),
        (1, N'Consumers', N'Consumer Login Management', N'CL', N'/ConsumerLoginManagement', N'Consumers', N'Consumer Login Management', 5, 1, 1, 0),
        (1, N'Consumers', N'Consumer Support Queries', N'SQ', N'/Consumer/SupportQueries', N'Consumers', N'Consumer Support Queries', 6, 1, 1, 0),
        (1, N'Consumers', N'Consumer Complaints', N'CO', N'/Consumer/Complaints', N'Consumers', N'Consumer Complaints', 7, 1, 1, 0),
        (1, N'Consumers', N'Consumer Service Requests', N'SR', N'/Consumer/ServiceRequests', N'Consumers', N'Consumer Service Requests', 8, 1, 1, 0),
        (1, N'Consumers', N'Consumer Challans', N'CC', N'/Consumer/Challans', N'Consumers', N'Consumer Challans', 9, 1, 1, 0),
        (1, N'Consumers', N'Consumer NDC Applications', N'ND', N'/Consumer/NdcApplications', N'Consumers', N'Consumer NDC Applications', 10, 1, 1, 0)
...
(
    SELECT
        ...
        s.ShowInSidebar,
        s.OpenInNewTab
    FROM child_menu_seed s
    LEFT JOIN dbo.MenuItems p
...
ON tgt.TenantId = src.TenantId
   AND tgt.Label = src.Label
   AND ISNULL(tgt.ParentId, 0) = ISNULL(src.ParentId, 0)
WHEN MATCHED THEN
    UPDATE SET
        tgt.Icon = src.Icon,
        tgt.Url = src.Url,
...
/* ============================================================
   11) SUPPORT QUERY CATEGORIES SEED
   ============================================================ */
...
/* ============================================================
   13) ADDITIONAL SEEDS / DEFAULT SETTINGS
   ============================================================ */
...
(
    SELECT
        CONVERT(UNIQUEIDENTIFIER, '50000000-0000-0000-0000-000000000001') AS TenantId
) AS src
ON tgt.TenantId = src.TenantId
WHEN MATCHED THEN
    UPDATE SET
