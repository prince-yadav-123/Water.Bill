-- Connection Type / Category Change module for Water.Bill Authority Portal.
...
SET @moduleName := 'Connection Type / Category Change';
...
SELECT 1, NULL, @moduleName, 'CT', '/ConnectionTypeCategoryChange', 'Consumers', @moduleName, @moduleId, 65, 1, 1, 0, NOW(6), 0
WHERE NOT EXISTS (
