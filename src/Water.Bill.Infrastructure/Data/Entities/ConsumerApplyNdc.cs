...
public partial class ConsumerApplyNdc
{
    ...
    public string? Level1Action1 { get; set; }

    public string? Level1Action2 { get; set; }

    public string? Level2Action1 { get; set; }

    public string? Level2Action2 { get; set; }
}
