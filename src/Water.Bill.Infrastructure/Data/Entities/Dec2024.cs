...
public partial class Dec2024
{
    ...
    public double? RecpNo { get; set; }

    public double? DisCd { get; set; }
    ...
    public double? RevBilFr { get; set; }
    ...
    public double? BlPadOld { get; set; }

    public double? Dup { get; set; }

    public double? Mst { get; set; }

    public double? RevConDt { get; set; }

    public double? A { get; set; }

    public double? Reb { get; set; }

    public double? ManLed { get; set; }
    ...
    public double? AcountNo { get; set; }
    ...
    public double? ChallanStatus { get; set; }
