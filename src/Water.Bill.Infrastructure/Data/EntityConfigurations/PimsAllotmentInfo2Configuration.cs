...
public class PimsAllotmentInfo2Configuration : IEntityTypeConfiguration<PimsAllotmentInfo2>
{
    public void Configure(EntityTypeBuilder<PimsAllotmentInfo2> entity)
    {
        entity
            .HasNoKey()
            .ToTable("pims_allotment_info2");
