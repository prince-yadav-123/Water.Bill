...
public class BankCounterpayDetailTransLogConfiguration : IEntityTypeConfiguration<BankCounterpayDetailTransLog>
{
    public void Configure(EntityTypeBuilder<BankCounterpayDetailTransLog> entity)
    {
        entity
            .HasNoKey()
            .ToTable("bank_counterpay_detail_trans_log");
