...
public class NameChangeDetailConfiguration : IEntityTypeConfiguration<NameChangeDetail>
{
    public void Configure(EntityTypeBuilder<NameChangeDetail> entity)
    {
        entity
            .HasNoKey()
            .ToTable("name_change_details");
        
        entity.HasIndex(e => e.AutoId, "IX_NAME_CHANGE_DETAILS_AUTO_ID_AUTO");
        ...
        entity.Property(e => e.SecurityAmount).HasColumnName("SECURITY_AMOUNT");
