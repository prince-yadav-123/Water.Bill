...
public class PimsAllotmentInfo6Configuration : IEntityTypeConfiguration<PimsAllotmentInfo6>
{
    public void Configure(EntityTypeBuilder<PimsAllotmentInfo6> entity)
    {
        entity
            .HasNoKey()
            .ToTable("pims_allotment_info6");
