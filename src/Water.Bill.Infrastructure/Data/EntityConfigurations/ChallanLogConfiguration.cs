...
public class ChallanLogConfiguration : IEntityTypeConfiguration<ChallanLog>
{
    public void Configure(EntityTypeBuilder<ChallanLog> entity)
    {
        entity
            .HasNoKey()
            .ToTable("challan_log");
        ...
        entity.Property(e => e.Key)
            .HasMaxLength(16)
            .HasColumnName("KEY");
        entity.Property(e => e.LabCharge).HasColumnName("lab_charge");
