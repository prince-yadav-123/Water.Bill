...
public class MasterSheetAug23Configuration : IEntityTypeConfiguration<MasterSheetAug23>
{
    public void Configure(EntityTypeBuilder<MasterSheetAug23> entity)
    {
        entity
            .HasNoKey()
            .ToTable("master_sheet_aug23");
        
        entity.Property(e => e.A).HasMaxLength(3);
