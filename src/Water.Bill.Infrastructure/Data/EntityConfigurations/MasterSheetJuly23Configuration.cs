...
public class MasterSheetJuly23Configuration : IEntityTypeConfiguration<MasterSheetJuly23>
{
    public void Configure(EntityTypeBuilder<MasterSheetJuly23> entity)
    {
        entity
            .HasNoKey()
            .ToTable("master_sheet_july23");
