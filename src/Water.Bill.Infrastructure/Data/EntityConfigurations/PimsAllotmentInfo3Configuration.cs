...
public class PimsAllotmentInfo3Configuration : IEntityTypeConfiguration<PimsAllotmentInfo3>
{
    public void Configure(EntityTypeBuilder<PimsAllotmentInfo3> entity)
    {
        entity
            .HasNoKey()
            .ToTable("pims_allotment_info3");
