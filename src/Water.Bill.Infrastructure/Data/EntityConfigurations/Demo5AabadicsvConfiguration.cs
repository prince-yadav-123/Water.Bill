...
public class Demo5AabadicsvConfiguration : IEntityTypeConfiguration<Demo5Aabadicsv>
{
    public void Configure(EntityTypeBuilder<Demo5Aabadicsv> entity)
    {
        entity
            .HasNoKey()
            .ToTable("demo_5_%_aabadicsv");
