...
public class MasterSheetSep23Configuration : IEntityTypeConfiguration<MasterSheetSep23>
{
    public void Configure(EntityTypeBuilder<MasterSheetSep23> entity)
    {
        entity
            .HasNoKey()
            .ToTable("master_sheet_sep23");
