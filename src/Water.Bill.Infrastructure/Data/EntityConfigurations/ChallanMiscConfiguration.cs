...
public class ChallanMiscConfiguration : IEntityTypeConfiguration<ChallanMisc>
{
    public void Configure(EntityTypeBuilder<ChallanMisc> entity)
    {
        entity
            .HasNoKey()
            .ToTable("challan_misc");
