...
public class JalPrintBillMasterAman341Configuration : IEntityTypeConfiguration<JalPrintBillMasterAman341>
{
    public void Configure(EntityTypeBuilder<JalPrintBillMasterAman341> entity)
    {
        entity
            .HasNoKey()
            .ToTable("jal_print_bill_master_aman_341");
