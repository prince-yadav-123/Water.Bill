...
public class ChallanJan2025Configuration : IEntityTypeConfiguration<ChallanJan2025>
{
    public void Configure(EntityTypeBuilder<ChallanJan2025> entity)
    {
        entity
            .HasNoKey()
            .ToTable("challan_jan2025");
