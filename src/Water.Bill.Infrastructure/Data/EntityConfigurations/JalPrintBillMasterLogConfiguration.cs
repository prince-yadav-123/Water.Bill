...
public class JalPrintBillMasterLogConfiguration : IEntityTypeConfiguration<JalPrintBillMasterLog>
{
    public void Configure(EntityTypeBuilder<JalPrintBillMasterLog> entity)
    {
        entity
            .HasNoKey()
            .ToTable("jal_print_bill_master_log");
