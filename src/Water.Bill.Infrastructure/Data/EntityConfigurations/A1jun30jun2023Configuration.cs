...
public class A1jun30jun2023Configuration : IEntityTypeConfiguration<A1jun30jun2023>
{
    public void Configure(EntityTypeBuilder<A1jun30jun2023> entity)
    {
        entity
            .HasNoKey()
            .ToTable("a1jun30jun2023");
