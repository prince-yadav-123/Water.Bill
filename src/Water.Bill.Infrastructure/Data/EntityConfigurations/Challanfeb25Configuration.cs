...
public class Challanfeb25Configuration : IEntityTypeConfiguration<Challanfeb25>
{
    public void Configure(EntityTypeBuilder<Challanfeb25> entity)
    {
        entity
            .HasNoKey()
            .ToTable("challanfeb25");
